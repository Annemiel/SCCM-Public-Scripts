#Cobbled together from various sources by Robert Holbert and John Puskar of Ohio State University.
...
#Params 
$strServer = "sccm-chm1"				#netbios name of server
$strCAName = "SCCM_CHM Site Server"		#CA Name on system strServer
#Get this following string by opening one of your client certificates and checking the 'certificate template' field.
